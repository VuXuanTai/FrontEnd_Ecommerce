        ...
        <div className="container-xxl">
          <div className="row">
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">ADD: 245 Định Công, Hoàng Mai, Hà Nội</address>
                <a href="tel:+84 978172115" className="mt-3 d-block mb-1 text-white">Tel: +84 978172115</a>
                <a href="mailto:taivx.1312@gmail.com" className="mt-2 d-block mb-0 text-white">
                  taivx.1312@gmail.com
                </a>
            ...
            <div className="col-3">
              ...
              <div className="footer-links d-flex flex-column">
                ...
                <Link className="text-white py-3 mb-1">Terms & Conditions</Link>
            ...
            <div className="col-2">
              ...
              <div className="footer-links d-flex flex-column">
                ...
                <Link className="text-white py-3 mb-1">Headphones</Link>
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}; Powered by Tai Vu
              </p>
            </div>
          </div>
        </div>
